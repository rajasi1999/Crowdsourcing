# Generated by Django 2.1.4 on 2019-03-03 05:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aadhar_id', models.CharField(default='0', max_length=12, unique=True)),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('organization_name', models.CharField(blank=True, max_length=128, unique=True)),
